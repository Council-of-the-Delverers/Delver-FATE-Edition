...
public class BouncingMissile extends Item implements Directional {
    public int damage = 1;
    ...
    public BouncingMissile(int tex, String name) {
        this();
        this.tex = tex;
        this.name = name;
        ignorePlayerCollision = true;
    ...
    public BouncingMissile(Vector3 pos, Vector3 dir, int tex, Entity owner) {
