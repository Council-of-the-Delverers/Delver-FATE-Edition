...
import com.interrupt.dungeoneer.entities.items.CraftingItem;
import com.interrupt.dungeoneer.entities.items.CraftingRow;
public class CraftingOverlay extends WindowOverlay {
    ...
    public CraftingOverlay(Player player, String title, String description, Array<ShopItem> items, TriggeredShop.CurrencyType currency) {
        this.player = player;
        this.titleText = title;
        this.descriptionText = description;
        this.items = items;
