...
public class BleedingEffect extends StatusEffect {
	...
	public BleedingEffect(int time, int damageTimer, int damage, boolean canKill) {
		this.name = StringManager.get("statuseffects.BleedingEffect.defaultNameText");
		this.timer = time;
		this.statusEffectType = StatusEffectType.BLEEDING;
	...
	private void doBleedingEffect(Actor owner) {
