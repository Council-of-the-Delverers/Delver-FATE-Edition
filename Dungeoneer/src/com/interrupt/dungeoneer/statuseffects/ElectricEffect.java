...
import com.interrupt.dungeoneer.statuseffects.BleedingEffect;
...
public class ElectricEffect extends StatusEffect {
    ...
    public ElectricEffect(int time, int damageTimer, int damage, boolean canKill) {
        this.name = StringManager.get("statuseffects.ShockEffect.defaultNameText");
        this.speedMod = 0.0f;
        this.timer = time;
